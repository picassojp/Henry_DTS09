...
UPDATE venta SET Cantidad = REPLACE(Cantidad, '\r', ''); -- reemplazar los saltos de línea (ENTER/RETURN)
...
where Sucursal NOT IN (select Sucursal from sucursal); -- ver qué sucursales de los empleados no se encuentran en la tabla de sucursales
